...
var ATTRIBUTES = ['src', 'alt', 'height', 'width', 'style'];
...
var Image = function (_Parchment$Embed) {
  ...
  _createClass(Image, [{
    ...
    key: 'create',
    value: function create(value) {
      var imageNode = ATTRIBUTES.reduce(function (node, attribute) {
        var attrPresent = Object.prototype.hasOwnProperty.call(value, attribute);
        if (attrPresent) {
          node.setAttribute(attribute, value[attribute]);
        }
        return node;
      }, _get(Image.__proto__ || Object.getPrototypeOf(Image), 'create', this).call(this, value));
